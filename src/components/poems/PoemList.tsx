...
export default function EnhancedPoemList({
  initialFeedItems,
  initialPagination,
}: EnhancedPoemListProps) {
  const {
    feedItems,
    setFeedItems,
    loading,
      ...
      <div className="text-center py-16 sm:py-24 px-4">
        <div className="max-w-lg mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <p className="text-muted-foreground text-base sm:text-lg leading-relaxed">
              Be the first to share your poetry with the world and inspire
          ...
          <div className="text-center py-8 sm:py-16 space-y-4 sm:space-y-6 px-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <p className="text-muted-foreground text-base sm:text-lg">
                You have explored all {feedItems.length} beautiful poems in our
                feed.
              </p>
            </div>
            <div className="pt-4">
