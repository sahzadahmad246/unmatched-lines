  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setAuthors(prev => 
          prev.map(a => a._id === editingAuthor._id ? data.author : a)
        );
        cancelEdit();
      } else {
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {author.city || "Location not specified"}
                          </p>
                        </div>
                      </div>
      ...
      <AlertDialog open={!!deleteAuthorId} onOpenChange={() => setDeleteAuthorId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete this author and cannot be undone. 
              All poems associated with this author may also be affected.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
